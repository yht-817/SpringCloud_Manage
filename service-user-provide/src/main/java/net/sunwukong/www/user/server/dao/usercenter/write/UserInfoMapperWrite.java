 ...
 */
@Mapper
public interface UserInfoMapperWrite extends BaseMapper<UserInfo> {
    ...
    // 插入当前的数据
    int addUserStates(@Param("userNo") String userNo,@Param("date") String date,@Param("log") String log,@Param("lat") String lat);
}
