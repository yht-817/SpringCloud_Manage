...
import net.sunwukong.www.marketing.server.util.webpay.WXPayConstants.SignType;
...
public class WXPayUtil {
    ...
    public static String getIP() {
        ...
        try {
            ...
            spbillcreateip = address.getHostAddress();//192.168.0.121
     ...
     *
     */
    public static String yuanToSubdivisions(String total_fee){
        if (StringUtils.isNotEmpty(total_fee)){
            return String.valueOf((new Double(Double.parseDouble(total_fee) / 100).intValue()));
        }
        return null;
