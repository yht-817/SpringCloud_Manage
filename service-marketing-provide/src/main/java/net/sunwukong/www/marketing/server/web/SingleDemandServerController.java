 ...
 **/
@RestController
@RequestMapping("/singledemandserver")
...
public class SingleDemandServerController extends BaseController {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "serverState", value = "类型(待审核:10290006 服务中:10290002 已完成:10290003 已结单:10290004)",paramType = "query"),
    })
    public ResponseData getServerList(@RequestBody(required = false) RequestData<Map<String,String>> requestData){
        return iSingleDemandServerService.getServerList(requestData.getData());
    }
    ...
    public ResponseData getServerDetails(@RequestBody(required = false) RequestData<Map<String,String>> requestData){
        return iSingleDemandServerService.getServerDetails(requestData.getData());
    }
    ...
    public ResponseData completeServer(@RequestBody(required = false) RequestData<Map<String,String>> requestData){
        return iSingleDemandServerService.updateServerStatusStayStatement(requestData.getData());
    }
}
