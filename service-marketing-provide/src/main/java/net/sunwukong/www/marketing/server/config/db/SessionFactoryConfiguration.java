...
@MapperScan(basePackages = SessionFactoryConfiguration.PACKAGE, sqlSessionFactoryRef = "marketingSqlSessionFactory")
public class SessionFactoryConfiguration {
    static final String PACKAGE = "net.sunwukong.www.marketing.server.dao";
    ...
    public SqlSessionFactory marketingSqlSessionFactory(@Qualifier("writeDataSource") DataSource dataSource)
            throws Exception {
