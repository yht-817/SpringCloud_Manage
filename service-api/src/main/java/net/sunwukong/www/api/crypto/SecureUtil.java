...
import com.sdkinfo.www.core.lang.Assert;
import com.sdkinfo.www.core.map.MapUtil;
...
import net.sunwukong.www.api.crypto.asymmetric.*;
import net.sunwukong.www.api.crypto.digest.DigestAlgorithm;
import net.sunwukong.www.api.crypto.digest.Digester;
import net.sunwukong.www.api.crypto.digest.HMac;
import net.sunwukong.www.api.crypto.digest.HmacAlgorithm;
import net.sunwukong.www.api.crypto.symmetric.AES;
import net.sunwukong.www.api.crypto.symmetric.DES;
import net.sunwukong.www.api.crypto.symmetric.DESede;
import net.sunwukong.www.api.crypto.symmetric.SymmetricCrypto;
